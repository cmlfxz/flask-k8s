...
@k8s.route('get_service_account_list',methods=('GET','POST'))
...
@k8s.route('/delete_service_account', methods=('GET', 'POST'))
...
@k8s.route('get_cluster_role_list',methods=('GET','POST'))
...
@k8s.route('get_cluster_role_detail',methods=('GET','POST'))
...
@k8s.route('/delete_cluster_role', methods=('GET', 'POST'))
...
@k8s.route('get_cluster_role_binding_list',methods=('GET','POST'))
...
@k8s.route('/delete_cluster_role_binding', methods=('GET', 'POST'))
...
@k8s.route('get_role_list',methods=('GET','POST'))
def get_role_list():
    data = json.loads(request.get_data().decode("utf-8"))
...
@k8s.route('get_role_detail',methods=('GET','POST'))
def get_role_detail():
    data = json.loads(request.get_data().decode("utf-8"))
    current_app.logger.debug("收到的数据:{}".format(data))
    namespace = handle_input(data.get("namespace"))
...
@k8s.route('/delete_role', methods=('GET', 'POST'))
def delete_role():
    data = json.loads(request.get_data().decode("utf-8"))
...
@k8s.route('get_role_binding_list',methods=('GET','POST'))
...
@k8s.route('/delete_role_binding', methods=('GET', 'POST'))
