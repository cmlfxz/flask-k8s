...
@k8s.route('/create_deploy',methods=('GET','POST'))
def create_deploy():
    error = ""
...
@k8s.route('/update_deploy_v2',methods=('GET','POST'))  
...
@k8s.route('/delete_deploy',methods=['POST'])  
def delete_deploy():
    data = json.loads(request.get_data().decode('UTF-8'))
...
# @k8s.route('/get_hpa__by_deployment_name',methods=('GET','POST'))
...
@k8s.route('/get_deployment_detail', methods=('GET', 'POST'))
...
@k8s.route('/get_deployment_toleration', methods=('GET', 'POST'))
