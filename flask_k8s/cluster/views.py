...
@cluster.route('/get_api_version',methods=['GET','POST'])
def get_api_version():
    list_dict = []
...
@cluster.route('/get_event_list',methods=('GET','POST'))
def get_event_list():
...
@cluster.route('/get_node_name_list', methods=('GET', 'POST'))
...
#节点列表页面使用
@cluster.route('/get_node_detail_list',methods=('GET','POST'))
...
# 集群详情页面使用
@cluster.route('/get_node_detail_list_v2',methods=('GET','POST'))
...
@cluster.route('/get_cluster_stats',methods=('GET','POST'))
...
@cluster.route('/get_component_status_list',methods=('GET','POST'))
