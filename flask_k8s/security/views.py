...
@security.route('/get_network_policy_list',methods=('GET','POST'))
...
@security.route('/delete_network_policy', methods=('GET', 'POST'))
...
@security.route('/get_istio_policy_list', methods=('GET', 'POST'))
...
@security.route('/delete_istio_policy', methods=('GET', 'POST'))
